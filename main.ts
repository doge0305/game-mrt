...
let destoryer = sprites.create(img`
    . . . . . . . c d . . . . . . . 
    . . . . . . . c d . . . . . . . 
    . . . . . . . c d . . . . . . . 
    . . . . . . . c b . . . . . . . 
...
if (story.checkLastAnswer("see tutorial@story")) {
    ...
    story.printCharacterText("bob will tell you how model 045632", "united earth government")
    story.printCharacterText("hi im bob model 045632.", "bob")
